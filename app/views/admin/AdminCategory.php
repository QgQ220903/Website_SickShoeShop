    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-light rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          <h5 class="fw-bold text-primary">Danh sách thể loại</h5>
...
<script>
  ...
  // hàm thêm mới thể loại vào database
  function insert_category() {
    // lấy ra tên thể loại từ input
    var category_name = $('#category_name').val();

    // kiểm tra trường hợp nhập tên thể loại rỗng
    if (category_name.trim() == "") {
      $('#categoryName_Error').text('Vui lòng nhập tên thể loại');
      return;
    }
    // thực hiện kiểm tra trùng lặp tên thể loại
    $.ajax({
      ...
      success: function (data, status) {
        ...
        } // trường hợp thể loại mới nhập vào
          ...
          success: function (data, status) {
            if (data === "Lỗi khi xóa") {
              ...
              Swal.fire({
                ...
                text: "Xóa thành công thể loại sản phẩm",
                icon: "success",
                confirmButtonColor: "#3459e6"
              });
            } fetch_data();
