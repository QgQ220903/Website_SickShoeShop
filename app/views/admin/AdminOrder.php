    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-light rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          <h5 class="mb-0 fw-bold text-primary">DANH SÁCH HÓA ĐƠN</h5>
          <a class="btn btn-primary" href="<?= ROOT ?>AdminOrder/addOrder"><i class="fa-solid fa-circle-plus"></i>
            Tạo Hóa Đơn
          </a>
        </div>
