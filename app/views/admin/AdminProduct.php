    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-light rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          <h5 class="fw-bold text-primary">Danh Sách Sản Phẩm</h5>
          <form class="d-none d-md-flex w-50">
            <input id="search_product" class="form-control border-0" type="search" placeholder="Tìm kiếm">
          </form>
          <a class="btn btn-primary" href="<?= ROOT ?>AdminProduct/add"><i class="fa-solid fa-circle-plus"></i>
            Thêm Sản Phẩm
          </a>
        </div>
